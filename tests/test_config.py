...
def test_get_apps_table_name():
    ...
    assert (
        table == "test-client-core-automation-apps"
...
def test_get_zones_table_name():
    ...
    assert (
        table == "test-client-core-automation-zones"
    ), f"Expected 'test-client-core-automation-zones', got {table}"
...
def test_get_portfolios_table_name():
    ...
    assert (
        table == "test-client-core-automation-portfolios"
    ), f"Expected 'test-client-core-automation-portfolios', got {table}"
